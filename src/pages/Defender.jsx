      ...
      <Box className="productsContent">
        ...
        <Box className="rightDiv">
          <Typography className="textStylesProducts" variant="body1">
            ...
            from earthquakes and shocks. They are made to be more flexible, ready
            to be deformed without losing strength, and demonstrate high
            welding ability, resulting in lower construction costs. This
            makes them an ideal choice for construction in earthquake-prone
            areas.
          </Typography>
          <Typography className="textStylesProducts" variant="body1">
            Sheikhoo Defender rebars comply with the American Standard for Testing
          ...
          <Box component="ul">
            ...
            <Box component="li">
              <Typography variant="body2" className="textStylesProducts">
                W60 = Low Alloy Steel A706
              </Typography>
            </Box>
            <Box component="li">
              <Typography variant="body2" className="textStylesProducts">
                Minimum Bar Elongation: 10% - 14%
              </Typography>
            </Box>
          </Box>
          <Typography
